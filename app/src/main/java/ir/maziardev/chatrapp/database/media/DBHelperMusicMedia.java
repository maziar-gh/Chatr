...
public class DBHelperMusicMedia extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = AppController.DATABASE_NAME;

    public static final String TABLE_NAME = "tbl_music";
    ...
    public DBHelperMusicMedia(Context context) {
