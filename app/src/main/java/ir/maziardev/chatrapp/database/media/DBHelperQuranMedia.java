...
public class DBHelperQuranMedia extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = AppController.DATABASE_NAME;

    public static final String TABLE_NAME = "tbl_quranm";
    ...
    public DBHelperQuranMedia(Context context) {
    ...
    public ArrayList<GridList> getAllRows() {
        ...
        while (res.isAfterLast() == false) {
            ...
            gridList.setSite(true);
            gridList.setMusic(true);
