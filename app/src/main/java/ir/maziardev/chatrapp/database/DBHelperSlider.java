...
public class DBHelperSlider extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = AppController.DATABASE_NAME;

    public static final String TABLE_NAME = "tbl_slider";
    ...
    public DBHelperSlider(Context context) {
    ...
    public ArrayList<Slider> getAllRows() {
        ArrayList<Slider> array_list = new ArrayList<>();
