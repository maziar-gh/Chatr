...
public class ImageViewerActivity extends AppCompatActivity implements View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ex != null) {
            ...
            Glide.with(this)
                    .load(ex.getString(Extras.EXTRA_URL.toString()))
                    .into(mImageView);

            /*String[] arr = ex.getString(AppController.EXTRA_IV_URL).split(",");
            for (int i = 0; i < arr.length; i++) {
                Button myButton = new Button(this);
                myButton.setText("صفحه " + i);
                ViewGroup.LayoutParams lp = new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
                linear_imageviewr.addView(myButton, lp);
            }*/
